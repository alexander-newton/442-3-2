...
addpath(genpath('/Users/edmanuel/Documents/PhD Courses/Macro'))
...
% Save final period's assets
aindsim_final=aindsim(:,Tsim);
...
%% If running final question

clearvars -except aindsim_final
